...
<div class="header">
    ...
    <div class="container">
        ...
        <div class="box-white box-info">
            <form method="GET" id="form-password" action="{{ route('change', ['id'=>3]) }}">                 
            <div class="row p-0">
                <div class="col-lg-3"></div>
                <div class="col-lg-6">
                    <div class="box-information-input">
                        <label for="input-username" class="information-label">Mật khẩu hiện tại</label>
                        <input id="matKhauHienTai"class="information-input readonly" name="txt_MatKhauHienTai" type="text">
                        @if(session('error'))
                    ...
                    <div class="box-information-input">
                        <label for="input-full-name" class="information-label">Mật khẩu mới</label>
                        <input id="matKhauMoi" class="information-input readonly" type="text" name="txt_MatKhauMoi">
                        
                    </div>                              
                    <div class="box-information-input">
                        <label class="information-label">Xác thực mật khẩu mới</label>
                        <input id="matKhauMoi1" class="information-input readonly" type="password" name="txt_MatKhauMoi1">
                    </div>     

                </div>
                <center><div style="margin-top: 50px;">
                    <a href="{{ route('change', ['id'=>3]) }}"><button class="btn btn-secondary" name="btn_DoiMatKhau" style="width: 200px;" >Đổi mật khẩu<button></a>                
                </div></center>
            </div>                                    
        </form>                                                                 
        </div>
    ...
    <script>
        $("#menu-item-account").addClass("active")       
    </script>
