...
<div class="banner">
    <div class="col-md-12">
     ...
     <div class="col-md-8" style="box-shadow: 2px 10px 10px 5px gray; border-radius: 30px; margin-top: 30px; background-color: white; height: 400px;">
        ...
        <div>
            ...
            <a href="http://127.0.0.1:8000/order-store-handle"><button style="margin-right: 10px; border-radius: 5px" class="btn btn-warning">Đang xử lý</button>
